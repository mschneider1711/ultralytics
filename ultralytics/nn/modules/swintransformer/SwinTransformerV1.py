...
@register_model
def swinv1_tiny(pretrained=False,pretrained_window_sizes = None, **kwargs):
...
@register_model
def swinv1_small(pretrained=False,pretrained_window_sizes = None, **kwargs):
    model = SwinTransformerV1(
        embed_dim=96,
        depths=[2, 2, 18, 2],
        num_heads=[3, 6, 12, 24],
...
@register_model
def swinv1_base(pretrained=False,pretrained_window_sizes = None, **kwargs):
    model = SwinTransformerV1(
        embed_dim=128,
        depths=[2, 2, 18, 2],
        num_heads=[4, 8, 16, 32],
